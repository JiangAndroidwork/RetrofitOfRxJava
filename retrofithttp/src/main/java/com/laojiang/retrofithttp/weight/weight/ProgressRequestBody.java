...
/**
 * 类介绍（必填）：上传文件自定义RequestBody
 * Created by Jiang on 2017/3/20 9:22.
 */
    ...
    private Sink sink(Sink sink) {
        return new ForwardingSink(sink) {
            ...
            public void write(Buffer source, long byteCount) throws IOException {
                ...
                Flowable.just(writtenBytesCount).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<Long>() {
                    @Override
